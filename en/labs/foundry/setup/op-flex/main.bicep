...
@description('Temporary tenant name assigned to the attendee (e.g. "contoso-abc123tenant"). Optional: defaults to subscription ID when not provided.')
  ...
  properties: {
    ...
    siteConfig: {
      appSettings: concat([
        ...
        { name: 'BillTemplate', value: 'https://raw.githubusercontent.com/warnov/multi-agentic-workshop/refs/heads/master/assets/bill-template.en.html' }
