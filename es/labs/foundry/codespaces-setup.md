...
3. Haz clic en **"Create codespace on `<branch>`"** — el botón muestra la rama en la que estás actualmente, así que asegúrate de que sea la rama indicada para este taller.
