...
# Estrategia: usar el comando 'zip' del sistema (Linux/containers), que con '.' incluye
# todos los archivos; si no está disponible (Windows), usar .NET ZipFile como respaldo,
# que tambien incluye los archivos ocultos.
