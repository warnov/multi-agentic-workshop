...
@description('Nombre del tenant temporal asignado al attendee (ej: "contoso-abc123tenant"). Opcional: usa el ID de la suscripción cuando no se proporciona.')
...
@description('Nombre del deployment del modelo (independiente del nombre del modelo).')
  ...
  properties: {
    ...
    siteConfig: {
      appSettings: concat([
        ...
        { name: 'BillTemplate', value: 'https://raw.githubusercontent.com/warnov/multi-agentic-workshop/refs/heads/master/assets/bill-template.html' }
